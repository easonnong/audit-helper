...
if __name__ == "__main__":
    ...
    compare_parser.add_argument("--target_a", help="Optional target file name for folder A")
    compare_parser.add_argument("--target_b", help="Optional target file name for folder B")
    ...
    scan_func_parser.add_argument("--extension_exclude", help="Comma-separated list of file extensions to be excluded")
    scan_func_parser.add_argument("--target_file", help="Optional target file")
    ...
    scan_url_parser.add_argument("--extension_exclude", help="Comma-separated list of URL patterns to be excluded")
    scan_url_parser.add_argument("--target_file", help="Optional target file")
